...
public class PlayerMove : MonoBehaviour
{
    ...
    // PlayerMove.cs 내부에 추가
    private bool isInputBlocked = false;

    public void SetInputBlocked(bool blocked)
    {
        isInputBlocked = blocked;
        Debug.Log($"[Player] 입력 차단 상태: {blocked}");
    }
    ...
    private void Start()
    {
        ...
        if (boxCollider != null)
        {
            ...
            crouchOffset = new Vector2(originalOffset.x, originalOffset.y - (originalSize.y * 0.25f));
        }
    ...
    private void Update()
    {
        ...
        if (stunController != null && stunController.IsForceCrouching())
        {
